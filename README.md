...
- `/peon install` opens a locale-aware OpenPeon browser, sorted by your system language, with type-to-filter search and multi-select install
...
```
/peon install           # browse all OpenPeon packs, locale-aware, searchable, multi-select
